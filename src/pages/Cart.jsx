  ...
  return (
    <div className="container mx-auto">
      <div className=" lg:flex lg:justify-center w-full">
        <header
          className=" flex lg:w-9/12 items-center gap-4 py-4 px-2 rounded-b-xl shadow-md"
        ...
        >
          <div className="">
            ...
            <div className=" flex justify-center">
              <img
                className=" absolute lg:h-96  bottom-1"
                src={Avatar}
                alt=""
              />
            </div>
        ...
        <>
          <div className=" lg:flex lg:justify-center w-full">
            <div className=" lg:w-9/12 w-full">
              ...
              <div className=" lg:flex lg:justify-center w-full">
                <div className=" lg:w-9/12 fixed bottom-4  w-full">
                  <button
                    ...
                    className="  text-white px-4 py-2  flex w-full justify-between rounded-xl"
                  >
